 ...
 */
class OnePressFR109LicenseManagerAdminPage extends FactoryFR109AdminPage  {
    ...
    public function assets(FactoryFR109ScriptList $scripts, FactoryFR109StyleList $styles) {
        ...
        $styles->add(ONEPRESS_FR109_URL . '/assets/css/license-manager.css');
        $scripts->add(ONEPRESS_FR109_URL . '/assets/js/license-manager.js');   
    }
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <p style="text-align: center;">
                                <img src="<?php echo ONEPRESS_FR109_URL . '/assets/img/how-to-find-key.png' ?>" />
                            </p>
                        </div>
                    </li>
                    <li>
