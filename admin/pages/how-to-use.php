...
class OnpImgEvr_HowToUsePage extends FactoryPages320_AdminPage  {
    ...
    public function premium() {
        ...
        <div class="onp-help-section">
            ...
            <p>
                The plugin you're using is a free edition of the premium plugin <a href="<?php echo onp_licensing_323_get_purchase_url( $this->plugin ) ?>">Image Elevator</a> sold on CodeCanyon. 
            </p>
            <p class='onp-remark'>
                <span class="onp-inner-wrap">
